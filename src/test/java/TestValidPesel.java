...
public class TestValidPesel {
    ...
    public void should_getValidBirthDate_when_peselIsFromXXICenturyFebruary29th() {
        ...
        String expectedBody = generateExpectedResult(pesel, true, "2020-02-29", "Female");
        Response response = get("https://peselvalidatorapitest.azurewebsites.net/api/Pesel?pesel=" + pesel);
        String actualBody = response.getBody().asString();
        Assert.assertEquals(actualBody, expectedBody);
    }
    ...
    public void should_getValidBirthDate_when_peselIsFromXXCenturyApril30th() {
        ...
        String expectedBody = generateExpectedResult(pesel, true, "1922-04-30", "Male");
        Response response = get("https://peselvalidatorapitest.azurewebsites.net/api/Pesel?pesel=" + pesel);
        String actualBody = response.getBody().asString();
        Assert.assertEquals(actualBody, expectedBody);
    }
    ...
    public void should_getValidBirthDate_when_peselIsFromXXICenturySeptember30th() {
        ...
        String expectedBody = generateExpectedResult(pesel, true, "2009-09-30", "Male");
        Response response = get("https://peselvalidatorapitest.azurewebsites.net/api/Pesel?pesel=" + pesel);
        String actualBody = response.getBody().asString();
        Assert.assertEquals(actualBody, expectedBody);
    }
    ...
    public void should_getValidBirthDate_when_peselIsFromXXICenturyOctober31st() {
        ...
        String expectedBody = generateExpectedResult(pesel, true, "1933-10-31", "Male");
        Response response = get("https://peselvalidatorapitest.azurewebsites.net/api/Pesel?pesel=" + pesel);
        String actualBody = response.getBody().asString();
        Assert.assertEquals(actualBody, expectedBody);
    }
